...
window.soundEnggBlogs.push({
    ...
    "content": `
            ...
            <div class="article-body">
                ...
                <p>If you are new to system tuning, you might open up a <a href="../app.html#siggen" class="text-primary font-bold hover:underline">signal generator</a> app or the oscillator on your digital console and see a list of options: <a href="../app.html#siggen" class="text-primary font-bold hover:underline">Pink Noise</a>, White Noise, <a href="../app.html#siggen" class="text-primary font-bold hover:underline">Sine Waves</a>, and Sweeps. A lot of young engineers just pick one at random, unmute the matrix, and start looking at their <a href="../app.html#rta" class="text-primary font-bold hover:underline">RTA</a>. That is a dangerous game. If you send the wrong type of test signal into a massive line array, you can actually fry your high-frequency drivers in a matter of seconds. Let’s break down the math behind how these signals work and when you should actually use them on a gig.</p>
